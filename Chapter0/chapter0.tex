...
\begin{equation}
  \sigma(E) = \frac{4\pi\lambdabar^{2}(2j + 1)}{(2s_{n} + 1)(2s_{t} + 1)}  \frac{\Gamma^{2}/4}{[(E-E_{r})^{2} + \Gamma^{2}/4]}
  \label{eq:breit-wigner}
\end{equation}

Along with $E$, the independent variable energy, $\Gamma$ is the resonance width, $\lambdabar$ the reduced particle wavelength, $E_{r}$ the resonance energy, $j$ the resonance spin, $s_{n}$ the neutron spin and $s_{t}$ the target spin \cite{Libby2005}. 
