...
% Nuclear physics
%   Cross-sections and their extreme range and non-linearity 
%   Resonance theory / compound nuclei formation and decay
%   Resonance parameter correlations (matrix, resonance widths, f(Z,E))

% Representations of nuclear data
%   Evaluated nuclear data (ENDFs) and their production
%   Continuous (or near continuous) forms like PENDFs, ACE files
%   Discretised formats like GENDF

% Usage of nuclear data
%   Radiation transport (stochastic & deterministic). Limitations?
%   Transmutation and activation – why discrete? Limitations?
...
% The underlying nuclear physics of compound nucleus formation and resonances
% How that physics is encoded in nuclear data 
