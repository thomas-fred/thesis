...
The data in table~\ref{tab:lead_by_lib} is shown as figure~\ref{fig:lead_by_lib}.
...
\begin{figure}[H]
%  \figuretitle{}
	\includegraphics[width=\textwidth]{rvadjust_param_Pb208_histogram}
	\caption{}
	\label{fig:pb208_rvadjust_hist}
\end{figure}

The TBR(parameter) correlations can be computed for \textsuperscript{206}Pb and \textsuperscript{207}Pb also, these are shown as figures~\ref{fig:pb206_param_correl} and \ref{fig:pb207_param_correl}.

\begin{figure}[H]
%  \figuretitle{}
	\includegraphics[width=\textwidth]{Pb206_param_correl}
	\caption{}
...
\begin{figure}[H]
%  \figuretitle{}
	\includegraphics[width=\textwidth]{Pb207_param_correl}
	\caption{}
...
The parameter correlation plots suggest that given the variance in input parameters, 
